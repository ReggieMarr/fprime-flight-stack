module obcA {
  ...
  topology obcA {
    ...
    connections Sequencer {
      ...
      cmdSeq.comCmdOut -> cmdSplitter.CmdBuff[1]
      
      # cmdDisp.seqCmdStatus -> cmdSeq.cmdResponseIn
      cmdSplitter.forwardSeqCmdStatus[1] -> cmdSeq.cmdResponseIn
    }
    ...
    connections Uplink {
      ...
      deframer.comOut -> cmdSplitter.CmdBuff[0]
      cmdSplitter.LocalCmd[0] -> proxyGroundInterface.seqCmdBuf
      cmdSplitter.LocalCmd[1] -> proxySequencer.seqCmdBuf
      ...
      proxyGroundInterface.seqCmdStatus -> cmdSplitter.seqCmdStatus[0]
      proxySequencer.seqCmdStatus -> cmdSplitter.seqCmdStatus[1]


      cmdSplitter.forwardSeqCmdStatus[0] -> deframer.cmdResponseIn
    ...
    connections hub {
      ...
      cmdSplitter.RemoteCmd[0] -> hub.portIn[0]
      cmdSplitter.RemoteCmd[1] -> hub.portIn[1]
      hub.portOut[0] -> cmdSplitter.seqCmdStatus[0]
      hub.portOut[1] -> cmdSplitter.seqCmdStatus[1]
    }
  }
